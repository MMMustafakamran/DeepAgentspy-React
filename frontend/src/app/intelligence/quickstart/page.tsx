    ...
    <>
      ...
      <Panel title="What it demonstrates">
        ...
        <p className="mt-3 text-sm leading-relaxed text-slate-700 dark:text-slate-300">
          ...
          This repo has no thread UI, so nothing else forces the choice: the
          new mount exists because the Intelligence page now asks for it, and it
          takes the same agent map, so the only variable between the two
          endpoints is the transport.
        </p>
        <div className="mt-4">
          <TryIt
