...
// This repo has no CLI recorder (no `core/cli/cast.ts`); the asciicast shape
// is small enough to state here so `evidenceCast` stays identical to the
// reference implementation and a terminal can be added later without touching
// this file.
