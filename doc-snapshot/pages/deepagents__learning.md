...
The video also shows [User Memory](/deepagents/intelligence/memories), then an expense-review workflow that becomes a skill.
...
For agent setup, use the [Mastra](/deepagents/intelligence/learned-skills#mastra), [LangGraph TypeScript](/deepagents/intelligence/learned-skills#langgraph-typescript), or [LangGraph Python](/deepagents/intelligence/learned-skills#langgraph-python) example. The delivery guide also covers [Google ADK](/deepagents/intelligence/learned-skills#google-adk), [BuiltInAgent](/deepagents/intelligence/learned-skills#builtinagent), and [Microsoft Agent Framework](/deepagents/intelligence/learned-skills#microsoft-agent-framework).
...
<Steps>
  <Step>
    ...
    Complete the [Intelligence quickstart](/deepagents/intelligence/quickstart). That page signs you in with the CLI and selects the project. Then send a message and make sure that it appears in [Rich Threads](/deepagents/threads). Open your project in [CopilotKit Intelligence](https://dashboard.operations.copilotkit.ai/) and make sure that Learning is available.
...
<Steps>
  ...
  <Step>
    ...
    For manual setup, follow the [framework adapter examples](/deepagents/intelligence/learned-skills#native-setup). Pick the adapter for the agent you already run. Configure that adapter in the agent server environment with the same project key and container ID used above.
    ...
    Keep the key server-side. Leave `CPK_INTELLIGENCE_SKILLS_REVISION` unset to follow the latest published Skills. See [container configuration](/deepagents/intelligence/learned-skills#configure-one-container) for self-hosted endpoints and exact revision pins.
  </Step>
...
| Delivery status is unavailable              | Select **Retry delivery status**. For self-hosted deployments, verify the delivery endpoint and migration are installed before relying on an adapter. See [deployment requirements](/deepagents/intelligence/learned-skills#deployment-requirements). |

## Related guides

- [CopilotKit Intelligence overview](/deepagents/intelligence/overview)
- [Connect CopilotKit Intelligence](/deepagents/intelligence/quickstart)
- [Rich Threads](/deepagents/threads)
- [Threads & Persistence Architecture](/deepagents/intelligence/threads-explained)
- [CopilotKit CLI](/deepagents/cli)
