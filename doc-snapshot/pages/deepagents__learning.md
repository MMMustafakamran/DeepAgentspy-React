...
<Steps>
  <Step>
    ...
    Complete the [Intelligence quickstart](/deepagents/intelligence/quickstart), then send a message and confirm that it appears in [Rich Threads](/deepagents/threads). Open your project in [CopilotKit Intelligence](https://dashboard.operations.copilotkit.ai/) and confirm that Learning is available.
