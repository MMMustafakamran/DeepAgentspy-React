...
`copilotkit skills download` remains supported for inspection, offline use, and unsupported frameworks. See the [Learning guide](/deepagents/learning) for the manual workflow.
