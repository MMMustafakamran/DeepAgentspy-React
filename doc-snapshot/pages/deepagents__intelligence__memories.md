...
<Steps>
  <Step>
    ...
    Complete the [Intelligence quickstart](/deepagents/intelligence/quickstart#set-it-up-manually) to connect your existing app and configure server-side user identity.
  </Step>
