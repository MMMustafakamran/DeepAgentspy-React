...
conversation, read [Threads & Persistence Architecture](/deepagents/intelligence/threads-explained)
instead.
...
<Steps>
  <Step>
    ...
    Complete the [Intelligence quickstart](/deepagents/intelligence/quickstart#set-it-up-manually). That page signs you in with the CLI, selects the project, and configures server-side user identity. Your existing app and agent stay in place.
  </Step>
...
- **Threads:** [Threads & Persistence Architecture](/deepagents/intelligence/threads-explained), the
  persistence model for a single conversation
- **Platform:** [CopilotKit Intelligence](/deepagents/intelligence/overview), where
  memory sits among the other pillars
- **Self-hosting:** [Self-hosting Intelligence](/deepagents/intelligence/self-hosting),
